...
function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // Make on function inside eventing a getter
...
function () {
  function Attributes(data) {
    ...
    this.data = data; // K will be type of T's key (every object key is a string, string can be type in ts)
